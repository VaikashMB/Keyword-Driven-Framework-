...
public class TestExecutor {
    ...
    private final String url = "jdbc:mysql://localhost:3306/keywords_db";
        ...
        try {
            switch (value.toLowerCase()) {
                case "chrome":
                    ...
                    break;
                case "firefox":
                    System.setProperty("webdriver.gecko.driver", "/home/vaikashmb/Downloads/geckodriver");
                    driver = new FirefoxDriver();
                    break;
                default:
                    throw new IllegalArgumentException("Invalid browser type specified. Supported types: Chrome, Firefox");
            }
